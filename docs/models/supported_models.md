...
| `FunAudioChatForConditionalGeneration` + `FunAudioChatCosyVoice3Code2Wav` | Fun-Audio-Chat (complete-turn input; streaming output) | `FunAudioLLM/Fun-Audio-Chat-8B` + `FunAudioLLM/Fun-CosyVoice3-0.5B-2512` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/FunAudioLLM/Fun-Audio-Chat-H200.md) |
